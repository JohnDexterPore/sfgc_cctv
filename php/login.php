...
if (isset($_POST['login_button'])) {
    ...
    $login_query = "SELECT * FROM tbl_user WHERE user_employee_number = '$user_employee_number' AND user_password = '$user_password'";
    ...
    if ($login_count) {
        ...
        $expiry = time() + (3600); // Cookie will expire in 30 days
        ...
        $login_result = sqlsrv_query($conn, $login_query);
        header("Location: /sfgc_cctv/pages/welcome_page.php");
    } else {
        echo '<script>
